...
$back_link = 'clients_view.php?id=' . array_int_value($assignment, 'client_id') . '&tab=achievements';
$back_button = '<a class="secondary" href="' . escape($back_link) . '">Back to client</a>';
