                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($task['last_run']): ?>
                                                    <small class="text-muted">
                                                        <?php 
                                                        $datetime = new DateTime($task['last_run'], new DateTimeZone($system_timezone));
                                            ...
                                            <td>
                                                <?php if ($task['next_run']): ?>
                                                    <small class="text-muted">
                                                        <?php 
                                                        $datetime = new DateTime($task['next_run'], new DateTimeZone($system_timezone));
                                                        echo $datetime->format('M j, Y g:i A');
                                                        ?>
                                                    </small>
                                                <?php else: ?>
                                    ...
                                    <?php foreach (array_slice($recent_logs, 0, 10) as $log): ?>
                                        <tr>
                                            <td>
                                                <small class="text-muted">
                                                    <?php 
                                                    $datetime = new DateTime($log['executed_at'], new DateTimeZone($system_timezone));
