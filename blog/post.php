...
$post_excerpt_stripped = strip_tags($post_excerpt);
$post_excerpt_compact = preg_replace('/\s+/', ' ', $post_excerpt_stripped);
$post_excerpt_final = trim($post_excerpt_compact === null ? $post_excerpt_stripped : $post_excerpt_compact);
$post_plain_text_stripped = strip_tags($post_content);
$post_plain_text_compact = preg_replace('/\s+/', ' ', $post_plain_text_stripped);
$post_plain_text_final = trim($post_plain_text_compact === null ? $post_plain_text_stripped : $post_plain_text_compact);
$meta_description_source = $post_excerpt_final !== '' ? $post_excerpt_final : $post_plain_text_final;
