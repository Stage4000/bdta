...
try {
    ...
    $credits_php = scalar_string(file_get_contents(dirname(__DIR__) . '/portal/credits.php'));
    ...
    $profile_php = scalar_string(file_get_contents(dirname(__DIR__) . '/portal/profile.php'));
    ...
    $contacts_api_php = scalar_string(file_get_contents(dirname(__DIR__) . '/portal/client_contacts_api.php'));
