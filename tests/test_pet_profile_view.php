...
function bdta_read_pet_profile_file(string $relative_path): string
{
...
$pets_view = bdta_read_pet_profile_file('client/pets_view.php');
bdta_assert_true(
...
$pets_list = bdta_read_pet_profile_file('client/pets_list.php');
bdta_assert_true(
...
$clients_view = bdta_read_pet_profile_file('client/clients_view.php');
bdta_assert_true(
...
$form_requests_create = bdta_read_pet_profile_file('client/form_requests_create.php');
bdta_assert_true(
...
$pets_edit = bdta_read_pet_profile_file('client/pets_edit.php');
bdta_assert_true(
