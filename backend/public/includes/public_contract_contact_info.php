...
function bdta_render_contract_client_contact_info(array $contract, bool $show_private_contact_details = true): string {
    $client_name = trim(bdta_contract_string_value($contract['client_name'] ?? ''));
    $client_email = trim(bdta_contract_string_value($contract['client_email'] ?? ''));
    $client_phone = trim(bdta_contract_string_value($contract['client_phone'] ?? ''));
    $client_address = trim(bdta_contract_string_value($contract['client_address'] ?? ''));
